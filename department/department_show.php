...
echo '<head><body><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search dept name.." title="Type in a dept name"></head><table id="mytable"><tr class="header">';
$sql = "CALL disp_dept()";
