...
echo '<head><body><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search usn.." title="Type in a usn"></head><table id="mytable"><tr class="header">';
$sql = "CALL disp_ea_marks()";
